    ...
    <body>
        <div class=\"row\" style=\"margin-bottom: 10px\">
            ...
            <div class=\"col-md-4 text-right\">
                <?php echo anchor(site_url('".$c_url."/create'), 'Create', 'class=\"btn btn-primary\"', 'onclick=\"return ".$c_url."_e(0);\"); ?>";
if ($export_excel == '1') {
...
$string .= "\n\t    
        ...
        <!-- Bootstrap modal -->
    <div class=\"modal fade\" id=\"".$c_url."_e\" tabindex=\"-1\" role=\"dialog\">
        <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">
            <div class=\"modal-content\">
                <div class=\"modal-header\">
                    <h5 class=\"modal-title\" id=\"modal_title\">".ucfirst($table_name)."</h5>
